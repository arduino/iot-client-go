...
func (r ApiDashboardsV2CloneRequest) Execute() (*ArduinoDashboardv2, *http.Response, error) {
	return r.ApiService.DashboardsV2CloneExecute(r)
}
...
func (a *DashboardsV2APIService) DashboardsV2CloneExecute(r ApiDashboardsV2CloneRequest) (*ArduinoDashboardv2, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/clone"
...
func (a *DashboardsV2APIService) DashboardsV2CreateExecute(r ApiDashboardsV2CreateRequest) (*ArduinoDashboardv2, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards"
...
func (a *DashboardsV2APIService) DashboardsV2DeleteShareExecute(r ApiDashboardsV2DeleteShareRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/shares/{user_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *DashboardsV2APIService) DashboardsV2LinkExecute(r ApiDashboardsV2LinkRequest) (*ArduinoVariableslinks, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/widgets/{widgetId}/variables"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/vnd.arduino.variableslinks+json", "application/vnd.goa.error+json"}
...
func (a *DashboardsV2APIService) DashboardsV2ListExecute(r ApiDashboardsV2ListRequest) ([]ArduinoDashboardv2, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/vnd.arduino.dashboardv2+json; type=collection", "application/vnd.goa.error+json"}
...
func (a *DashboardsV2APIService) DashboardsV2ListSharesExecute(r ApiDashboardsV2ListSharesRequest) ([]ArduinoDashboardshare, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/shares"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/vnd.arduino.dashboardshare+json; type=collection", "application/vnd.goa.error+json"}
...
func (a *DashboardsV2APIService) DashboardsV2RequestAccessExecute(r ApiDashboardsV2RequestAccessRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/share_request"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiDashboardsV2TemplateRequest) Execute() (*ArduinoDashboardv2template, *http.Response, error) {
	return r.ApiService.DashboardsV2TemplateExecute(r)
}
...
func (a *DashboardsV2APIService) DashboardsV2TemplateExecute(r ApiDashboardsV2TemplateRequest) (*ArduinoDashboardv2template, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/dashboards/{id}/template"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/vnd.arduino.dashboardv2template+json", "application/vnd.goa.error+json"}
