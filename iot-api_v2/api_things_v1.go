...
func (a *ThingsV1ApiService) ThingsV1Create(ctx context.Context, createThingsV1Payload CreateThingsV1Payload, localVarOptionals *ThingsV1CreateOpts) (ArduinoThing, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things"
...
@return ArduinoThing
*/
func (a *ThingsV1ApiService) ThingsV1CreateSketch(ctx context.Context, id string, thingSketch ThingSketch) (ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things/{id}/sketch"
...
func (a *ThingsV1ApiService) ThingsV1Delete(ctx context.Context, id string, localVarOptionals *ThingsV1DeleteOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
@return ArduinoThing
*/
func (a *ThingsV1ApiService) ThingsV1DeleteSketch(ctx context.Context, id string) (ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *ThingsV1ApiService) ThingsV1Layout(ctx context.Context, id string, localVarOptionals *ThingsV1LayoutOpts) (ArduinoThing, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things/{id}/layout"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *ThingsV1ApiService) ThingsV1List(ctx context.Context, localVarOptionals *ThingsV1ListOpts) ([]ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ThingsV1ApiService shadow things_v1
Publish the last property values to MQTT
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The id of the thing
 * @param thingPropertiesValues
*/
func (a *ThingsV1ApiService) ThingsV1Shadow(ctx context.Context, id string, thingPropertiesValues ThingPropertiesValues) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things/{id}/shadow/send"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	// body params
	localVarPostBody = &thingPropertiesValues
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
...
func (a *ThingsV1ApiService) ThingsV1Show(ctx context.Context, id string, localVarOptionals *ThingsV1ShowOpts) (ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *ThingsV1ApiService) ThingsV1Update(ctx context.Context, id string, thing Thing, localVarOptionals *ThingsV1UpdateOpts) (ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return ArduinoThing
*/
func (a *ThingsV1ApiService) ThingsV1UpdateSketch(ctx context.Context, id string, sketchId string) (ArduinoThing, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iot/v1/things/{id}/sketch/{sketchId}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sketchId"+"}", fmt.Sprintf("%v", sketchId), -1)
