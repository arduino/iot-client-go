...
func (a *DevicesV2APIService) DevicesV2CreateExecute(r ApiDevicesV2CreateRequest) (*ArduinoDevicev2, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices"
...
func (a *DevicesV2APIService) DevicesV2DeleteExecute(r ApiDevicesV2DeleteRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices/{id}"
...
func (a *DevicesV2APIService) DevicesV2GetEventsExecute(r ApiDevicesV2GetEventsRequest) (*ArduinoDevicev2EventProperties, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices/{id}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *DevicesV2APIService) DevicesV2GetPropertiesExecute(r ApiDevicesV2GetPropertiesRequest) (*ArduinoDevicev2properties, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices/{id}/properties"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *DevicesV2APIService) DevicesV2GetStatusEventsExecute(r ApiDevicesV2GetStatusEventsRequest) (*ArduinoDevicev2StatusEvents, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices/{id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiDevicesV2RemoveHardwareIDRequest struct {
	ctx context.Context
	ApiService *DevicesV2APIService
	id string
	xOrganization *string
...
func (r ApiDevicesV2RemoveHardwareIDRequest) XOrganization(xOrganization string) ApiDevicesV2RemoveHardwareIDRequest {
	r.xOrganization = &xOrganization
	return r
}

func (r ApiDevicesV2RemoveHardwareIDRequest) Execute() (*ArduinoDevicev2, *http.Response, error) {
	return r.ApiService.DevicesV2RemoveHardwareIDExecute(r)
}

/*
DevicesV2RemoveHardwareID removeHardwareID devices_v2

Removes the unique hardware id from the device

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id The id of the device
 @return ApiDevicesV2RemoveHardwareIDRequest
*/
func (a *DevicesV2APIService) DevicesV2RemoveHardwareID(ctx context.Context, id string) ApiDevicesV2RemoveHardwareIDRequest {
	return ApiDevicesV2RemoveHardwareIDRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ArduinoDevicev2
func (a *DevicesV2APIService) DevicesV2RemoveHardwareIDExecute(r ApiDevicesV2RemoveHardwareIDRequest) (*ArduinoDevicev2, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicesV2APIService.DevicesV2RemoveHardwareID")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iot/v2/devices/{id}/remove-uhwid"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *DevicesV2APIService) DevicesV2TimeseriesExecute(r ApiDevicesV2TimeseriesRequest) (*ArduinoDevicev2propertyvalues, *http.Response, error) {
	...
	localVarPath := localBasePath + "/iot/v2/devices/{id}/properties/{pid}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
