...
func (o *ThingSketch) UnmarshalJSON(data []byte) (err error) {
	varThingSketch := _ThingSketch{}

	err = json.Unmarshal(data, &varThingSketch)

	if err != nil {
		return err
	}

	*o = ThingSketch(varThingSketch)
